...
describe("propagators/neq.spec", function() {
  ...
  it('should exist', function() {
    expect(propagator_neq_step_bare).to.be.a('function');
  });
  ...
  describe('with one solved domain', function() {
    ...
    function test(value, domain1, result) {
      let domain2 = spec_d_create_range(value, value);
  ...
  describe('two solved domains', function() {
    ...
    function test(value1, value2) {
      let domain1 = spec_d_create_range(value1, value1);
      let domain2 = spec_d_create_range(value2, value2);
