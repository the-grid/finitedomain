...
describe('src/domain.spec', function() {
  ...
  describe('toList', function() {
    ...
    it('should require a domain', function() {
      expect(() => domain_toList()).to.throw('ONLY_NUMDOM_OR_STRDOM');
    });
  ...
  describe('domain_removeNextFromList', function() {
    ...
    it('should require an array', function() {
      expect(() => domain_removeNextFromList(null, [0])).to.throw('ONLY_NUMDOM_OR_STRDOM');
    });

    it('should require a list', function() {
      expect(() => domain_removeNextFromList(fixt_numdom_range(1, 2))).to.throw('A_EXPECTING_LIST');
    });
    ...
    describe('strdom', function() {
      ...
      it('should normalize to a numdom if possible', function() {
        expect(domain_removeNextFromList(fixt_strdom_ranges([2, 24], [SUP, SUP]), [SUP])).to.eql(fixt_numdom_range(2, 24));
        expect(domain_removeNextFromList(fixt_strdom_ranges([2, 24], [30, 30]), [30])).to.eql(fixt_numdom_range(2, 24));
        expect(domain_removeNextFromList(fixt_strdom_range(2, 31), [31])).to.eql(fixt_numdom_range(2, 30));
      });

      it('should normalize to a solved numdom if possible', function() {
        expect(domain_removeNextFromList(fixt_strdom_range(SUP - 1, SUP), [SUP])).to.eql(fixt_numdom_solved(SUP - 1));
        expect(domain_removeNextFromList(fixt_strdom_range(200, 201), [200])).to.eql(fixt_numdom_solved(201));
      });
    });
    ...
    describe('numdom', function() {
      ...
      it('should normalize to a solved numdom if possible', function() {
        expect(domain_removeNextFromList(fixt_numdom_range(0, 1), [1])).to.eql(fixt_numdom_solved(0));
        expect(domain_removeNextFromList(fixt_numdom_range(0, 1), [0])).to.eql(fixt_numdom_solved(1));
        expect(domain_removeNextFromList(fixt_numdom_range(20, 21), [20])).to.eql(fixt_numdom_solved(21));
      });
    });
    ...
    describe('solved numdom', function() {
      ...
      it('should work with solved numdoms', function() {
        ...
        for (let i = 0; i < nums.length; ++i) {
          ...
          expect(domain_removeNextFromList(fixt_numdom_solved(n), [n]), 'n=' + n + ',q=n').to.equal(EMPTY);
          expect(domain_removeNextFromList(fixt_numdom_solved(n), [5]), 'n=' + n + ',q=5').to.equal(fixt_numdom_solved(n));
        }
      });
    });
  });
  ...
  describe('isValue', function() {
    ...
    it('should require a domain', function() {
      expect(() => domain_isValue()).to.throw('ONLY_NUMDOM_OR_STRDOM');
    });
  ...
  describe('domain_removeValue', function() {
    ...
    describe('strdom', function() {
      ...
      it('should require a domain', function() {
        expect(() => domain_removeValue(null, 15)).to.throw('ONLY_NUMDOM_OR_STRDOM');
      });
  ...
  describe('intersection', function() {
    ...
    it('should require two domains', function() {
      expect(() => domain_intersection()).to.throw('ONLY_NUMDOM_OR_STRDOM');
      expect(() => domain_intersection(EMPTY_STR)).to.throw('ONLY_NUMDOM_OR_STRDOM');
      expect(() => domain_intersection(null, EMPTY_STR)).to.throw('ONLY_NUMDOM_OR_STRDOM');
    });
    ...
    describe('solved numdom', function() {
      ...
      it('should work with two solved numdoms', function() {
        for (let i = 0; i <= SMALL_MAX_NUM; ++i) {
          ...
          expect(domain_intersection(fixt_numdom_solved(i), fixt_numdom_solved(SUP)), 'i=' + i + ',left, no').to.equal(EMPTY);
          expect(domain_intersection(fixt_numdom_solved(SUP), fixt_numdom_solved(i)), 'i=' + i + ',right,no').to.equal(EMPTY);
        }
      });

      it('should work with two numdoms, one solved', function() {
        expect(domain_intersection(fixt_numdom_solved(SUP), fixt_numdom_nums(0, 1)), 'SUP left').to.equal(EMPTY);
        expect(domain_intersection(fixt_numdom_nums(0, 1), fixt_numdom_solved(SUP)), 'SUP right').to.equal(EMPTY);
      ...
      it('should work with solved numdom and strdom', function() {
        ...
        for (let i = 0; i < nums.length; ++i) {
          ...
          expect(domain_intersection(fixt_numdom_solved(n), fixt_strdom_nums(...(nums.filter(x => x !== n)))), 'i=' + n + ',left').to.equal(EMPTY);
          expect(domain_intersection(fixt_strdom_nums(...(nums.filter(x => x !== n))), fixt_numdom_solved(n)), 'i=' + n + ',left').to.equal(EMPTY);
        }
      });
    });
  });
  ...
  describe('size', function() {
    ...
    it('should require a domain', function() {
      expect(_ => domain_size()).to.throw('ONLY_NUMDOM_OR_STRDOM');
  ...
  describe('domain_mul', function() {
    ...
    it('should require domains', function() {
      expect(() => domain_mul()).to.throw('ONLY_NUMDOM_OR_STRDOM');
      expect(() => domain_mul(fixt_strdom_empty())).to.throw('ONLY_NUMDOM_OR_STRDOM');
      expect(() => domain_mul(null, fixt_strdom_empty())).to.throw('ONLY_NUMDOM_OR_STRDOM');
    });
  ...
  describe('domain_divby', function() {
    ...
    it('should require domains', function() {
      expect(() => domain_divby()).to.throw('ONLY_NUMDOM_OR_STRDOM');
      expect(() => domain_divby(fixt_strdom_empty())).to.throw('ONLY_NUMDOM_OR_STRDOM');
      expect(() => domain_divby(null, fixt_strdom_empty())).to.throw('ONLY_NUMDOM_OR_STRDOM');
    });
    ...
    describe('solved numdoms', function() {
      ...
      it('should work with solved domains', function() {
        ...
        for (let i = 0; i < nums.length; ++i) {
          ...
          if (lt >= 0) expect(domain_removeGte(fixt_numdom_solved(n), lt), 'n=' + n + ',lt').to.equal(EMPTY);
          if (eq >= 0 && eq <= SUP) expect(domain_removeGte(fixt_numdom_solved(n), eq), 'n=' + n + ',eq').to.equal(EMPTY);
    ...
    describe('solved numdoms', function() {
      ...
      it('should work with solved domains', function() {
        ...
        for (let i = 0; i < nums.length; ++i) {
          ...
          if (eq >= 0 && eq <= SUP) expect(domain_removeLte(fixt_numdom_solved(n), eq), 'n=' + n + ',eq').to.equal(EMPTY);
          if (gt <= SUP) expect(domain_removeLte(fixt_numdom_solved(n), gt), 'n=' + n + ',gt').to.equal(EMPTY);
        }
      });
    });
  });
