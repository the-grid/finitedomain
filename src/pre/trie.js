...
function trie_create(valuesByIndex, initialLength, initialBitsize) {
  ...
  if (!size) THROW('fixme; trie_create'); // blabla it's possible the constant is not yet initialized due to minification. dont initialize a trie in module global space
